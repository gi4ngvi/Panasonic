...
public class ID_BA_RegistrationTest extends SeleniumTest {
    ...
    private static final String MSG_PASSWORD_NOT_MATCH = "Silakan masukkan nilai yang sama lagi.";
    private static final String MSG_REGISTER_SUCCESS = "Thank you for registering with Panasonic Online Store.";
    private static final String MSG_NICKNAME_MAXLENGTH = "Harap masukkan kurang atau sama dengan simbol 30.";
    private static final String MSG_EMAIL_INVALID = "Harap masukkan alamat email yang valid (Ex: johndoe@domain.com).";
    ...
    protected void preCondition() {
        ...
        cusEmpty = new CustomerInformation.Builder().email("").password("").passwordConfirm("").name("").nickName("").dateOfBirth("").identityCardNumber("").subscribeNewsletter(false).title("Mr.").typeOfIdentityCard("-- Choose --").build();
