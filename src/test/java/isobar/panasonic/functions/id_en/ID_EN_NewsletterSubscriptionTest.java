...
public class ID_EN_NewsletterSubscriptionTest extends SeleniumTest {
    CustomerInformation cus;
    GmailUtility gmailUtility;
    ActionUtility actionUtility;
    AccountInformationPage accountInformationPage;
    NewsletterSubscriptionPage newsletterSubscriptionPage;
    String SUBSCRIPTION_SUCCESS_MSG, UNSUBSCRIPTION_SUCCESS_MSG, SUBSCRIPTION_MAIL_TITLE, UNSUBSCRIPTION_MAIL_TITLE, SENDER_EMAIL_SUBSCRIBE, SENDER_EMAIL_UNSUBSCRIBE, MSG_NOT_SEND_MAIL_SUBSCRIBE, MSG_NOT_SEND_MAIL_UNSUBSCRIBE;
    ...
    protected void preCondition() {
        ...
        UNSUBSCRIPTION_SUCCESS_MSG = "We removed the subscription.";
        SUBSCRIPTION_SUCCESS_MSG = "We saved the subscription.";
        SUBSCRIPTION_MAIL_TITLE = "Newsletter subscription success";
        UNSUBSCRIPTION_MAIL_TITLE = "Newsletter unsubscription success";
