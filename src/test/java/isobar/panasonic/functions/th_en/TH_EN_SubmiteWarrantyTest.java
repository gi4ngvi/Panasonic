...
public class TH_EN_SubmiteWarrantyTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        warrantyInvalidCardNo.setWarrantyCardNumber(RUN_ID + stringUtility.getRandomCharacter(20));
        warrantyInvalidCardNo.setSerialNumber(RUN_ID + stringUtility.getRandomCharacter(10));
        MSG_REQUIRED = "This is a required field.";
        MSG_SUCCESS = "Register warranty is successful.";
        MSG_CARDNO_INVALID = "Something went wrong during your request.";
    }
