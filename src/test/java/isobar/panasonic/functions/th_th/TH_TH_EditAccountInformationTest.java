...
public class TH_TH_EditAccountInformationTest extends SeleniumTest {
    ...
    private static final String MSG_ACCOUNT_SAVE_SUCCESS = "คุณบันทึกข้อมูลบัญชีแล้ว.";
    ...
    protected void preCondition() {
        ...
        cus_edit.setFirstName(stringUtility.getRandomCharacter(5));
        cus_edit.setLastName(stringUtility.getRandomCharacter(5));
        cus_edit.setNickName(stringUtility.getRandomCharacter(10));
        cus_edit.setDateOfBirth("1990-10-10");
        cusEmpty = new CustomerInformation.Builder().firstName("").lastName("").nickName("").title("Mr.").dateOfBirth("").build();
        ...
        billingAddress.setStreet(stringUtility.getRandomCharacter(10));
    ...
    public void changeBothEmailAndPassword() {
        ...
        ReportUtility.getInstance().logInfo(String.format("Password change: %s", emailChange2));
        accountInformationPage = headerPage.gotoAccountInfo();
        editAccountPage = accountInformationPage.openAccountInfomationTab();
