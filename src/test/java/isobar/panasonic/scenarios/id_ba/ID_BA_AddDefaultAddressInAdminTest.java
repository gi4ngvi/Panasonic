...
public class ID_BA_AddDefaultAddressInAdminTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressEmpty = new Address.Builder().name("").company("").mobileNumber("").telephone("").state("Please select a region, state or province.").city("").street("").zip("").build();
