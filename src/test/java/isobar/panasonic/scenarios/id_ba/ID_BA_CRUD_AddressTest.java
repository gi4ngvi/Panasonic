...
public class ID_BA_CRUD_AddressTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressDefault.setCompany(stringUtility.getRandomCharacter(10));
        ...
        addressEdit.setCompany(stringUtility.getRandomCharacter(10));
        addressEmpty = new Address.Builder().name("").company("").telephone("").state("Silakan pilih wilayah, negara bagian atau provinsi.").city("").street("").zip("").build();
    }
