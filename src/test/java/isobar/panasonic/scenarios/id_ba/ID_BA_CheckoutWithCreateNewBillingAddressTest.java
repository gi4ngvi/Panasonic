...
public class ID_BA_CheckoutWithCreateNewBillingAddressTest extends SeleniumTest {
    ...
    private static final String MSG_ORDER_SUCCESS = "Terima kasih atas pembelian Anda!";
    ...
    protected void preCondition() {
        ...
        billingAddressEmpty = new Address.Builder().name("").company("").telephone("").zip("").street("").state("Silakan pilih wilayah, negara bagian atau provinsi.").city("").build();
