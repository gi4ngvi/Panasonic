...
public class ID_EN_AddDefaultAddressInAdminTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressEmpty = new Address.Builder().name("").company("").telephone("").mobileNumber("").state("Please select a region, state or province.").city("").street("").zip("").build();
