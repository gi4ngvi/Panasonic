...
public class ID_EN_CRUD_AddressTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressEmpty = new Address.Builder().name("").company("").telephone("").state("Please select a region, state or province.").city("").street("").zip("").build();
    }
