...
public class ID_EN_CheckoutWithCreateNewShippingAddressTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        shippingAddressEmpty = new Address.Builder().name("").company("").city("").telephone("").zip("").street("").state("Please select a region, state or province.").build();
