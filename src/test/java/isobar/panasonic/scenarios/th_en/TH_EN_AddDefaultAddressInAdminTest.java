...
public class TH_EN_AddDefaultAddressInAdminTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressEmpty = new Address.Builder().firstName("").company("").lastName("").mobileNumber("").telephone("").country("Thailand").state("Please select a region, state or province.").city("").street("").zip("").build();
