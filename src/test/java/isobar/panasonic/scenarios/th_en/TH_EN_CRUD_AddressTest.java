...
public class TH_EN_CRUD_AddressTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressEmpty = new Address.Builder().firstName("").lastName("").telephone("").state("Please select a region, state or province.").street("").zip("").build();
    }
