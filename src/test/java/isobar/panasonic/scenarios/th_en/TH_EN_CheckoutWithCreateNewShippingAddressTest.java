...
public class TH_EN_CheckoutWithCreateNewShippingAddressTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        shippingAddressEmpty = new Address.Builder().firstName("").lastName("").company("").telephone("").zip("").street("").state("Please select a region, state or province.").build();
