...
public class VN_EN_CheckoutWithCreateNewBillingAddressTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        billingAddressEmpty = new Address.Builder().name("").company("").telephone("").city("Please select a region, state or province.").district("").ward("").street("").build();
