...
public class VN_VN_AddDefaultAddressInAdminTest extends SeleniumTest {
    ...
    protected void preCondition() {
        ...
        addressEmpty = new Address.Builder().name("").company("").telephone("").mobileNumber("").city("Please select a region, state or province.").ward("").district("").street("").build();
